...
#
#ident	"@(#)polaris.sh	1.1	06/01/21 CP"
#
...
#
# [XXX_PPC] PowerPC port removes -t
NIGHTLY_OPTIONS="-FNnadDmr";			export NIGHTLY_OPTIONS

# This is a variable for the rest of the script - GATE doesn't matter to
# nightly itself
GATE=polaris-trunk;				export GATE

# CODEMGR_WS - where is your workspace at (or what should nightly name it)
CODEMGR_WS="$HOME/polaris/$GATE";		export CODEMGR_WS
...
#
STAFFER=`/opt/csw/bin/gwhoami`;		export STAFFER
...
MACH=ppc;					export MACH
NATIVE_MACH=`uname -p`;				export NATIVE_MACH
...
# The PowerPC port needs special GNU_ROOT settings.  As long as we
# cross-compile code, the GNU_ROOT should be in sync with the cross
# tool-chain.
GNU_ROOT=/opt/polaris/powerpc-solaris2;		export GNU_ROOT

# The PowerPC port cannot run the shadow compiler, because Sun does
# not have its own C compiler for PowerPC.
