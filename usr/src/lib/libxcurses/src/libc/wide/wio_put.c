...
#pragma ident	"@(#)wio_put.c	1.4	05/06/08 SMI"
...
#if M_RCSID
#ifndef lint
static char rcsID[] = "$Header: /rd/src/libc/wide/rcs/wio_put.c 1.1 1995/07/26 17:51:21 ant Exp $";
#endif
#endif
...
t_wide_io *wio;
{
	...
	if ((mb_len = wcrtomb((char *) wio->_mb, wc, &wio->_state)) < 0)
