...
#pragma	ident	"@(#)failwide.c	1.2	05/06/08 SMI"
 ...
 * this test should fail the second allocation.
 *
 * cc -O -o failwide failwide.c -lmtmalloc
 */
...
main(int argc, char ** argv)
{
	...
	bar = (char *)sbrk(0);
	printf ("After big malloc brk is %p, should be the same.\n", bar);
}
