...
#pragma ident	"@(#)frudefs.c	1.14	06/05/30 SMI"
...
fru_enum_t Vendor[] = {
	...
	{ 0x462, "Vihana, Inc." },
	{ 0x464, "GateChange Techologies" },
	{ 0x467, "Gigaram" },
	{ 0x468, "ARC International" },
	...
	{ 0x586, "CompuRAM GmbH" },
	{ 0x589, "Excalibrus Technogies Ltd" },
