 ...
 * 
 * Originated from uts/sun/sys/bootconf.h
 */

#ifndef	_SYS_BOOTCONF_H
#define	_SYS_BOOTCONF_H

#pragma ident	"@(#)bootconf.h	1.60	05/10/30 SMI" /* SunOS-4.0 1.7 */
...
/* copied the MAGIC_PHYS from intel/sys/bootconf.h to make 
 * uts/common/krtld/bootrd.c pass
 */
...
typedef struct bootops {
...
#ifndef _LP64
	uint32_t	bsys_pad2[3]; /* pointers above get larger */
#endif
	/*
	 ...
	 */
	void	(*bsys_printf)(struct bootops *bop, char *fmt, ...);
} bootops_t;
...
typedef unsigned long boot_cell_t;
