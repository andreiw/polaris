...
#pragma ident	"@(#)modstubs.s	1.176	06/08/25 SMI"

#include <sys/asm_linkage.h>

/*
 * The following defines should be provided by assym.h.
 * Well, at least that is the way it is done for sparc and x86.
 * Better yet would be a more carefully crafted modctl.h, which
 * would supply only the pure #defines for _ASM consumers.
 *
 * For now, we cut'n'paste the defines we need from
