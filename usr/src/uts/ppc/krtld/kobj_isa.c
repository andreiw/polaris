...
#include <asm/flush.h> /* for inlined doflush */
...
/*
 * Flush instruction cache after updating text, i.e. making
 * the memory at {addr, addr+size} valid for instruction execution.
 *
