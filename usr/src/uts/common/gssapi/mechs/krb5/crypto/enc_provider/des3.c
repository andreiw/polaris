...
#pragma ident	"@(#)des3.c	1.10	05/09/26 SMI"
	...
	krb5_const krb5_data *input, krb5_data *output, int encrypt)
{
    ...
    KRB5_LOG0(KRB5_INFO, "k5_des3_docrypt() start");
		...
		krb5_keyblock *key)
{
    ...
    KRB5_LOG0(KRB5_INFO, "k5_des3_make_key() start\n");
...
#endif /* _KERNEL */
    KRB5_LOG0(KRB5_INFO, "k5_des3_make_key() end\n");
    return(ret);
}
