...
#pragma ident	"@(#)hat.h	1.107	06/06/20 SMI"
...
/*
 * hat_getkpfnum() is never supported on amd64 or PPC
 * and will be removed from other platforms in future release.
 */
#if !defined(__amd64) && !defined(__ppc)
