...
#pragma ident	"@(#)ncalogd.h	1.6	05/06/08 SMI"
...
#define	nca_fio_nxt_name(fiop)		(fiop)->iov[(fiop)->hdr.cnt].name
#define	nca_fio_nxt_size(fiop)		(fiop)->iov[(fiop)->hdr.cnt].size
#define	nca_fio_nxt_offset(fiop)	(fiop)->iov[(fiop)->hdr.cnt].offset
#define	nca_fio_nxt_file(fiop)		(fiop)->iov[(fiop)->hdr.cnt].file
