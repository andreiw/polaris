...
#pragma ident	"@(#)ipsecespddi.c	1.15	05/06/08 SMI"
...
#define	INET_STRTAB	ipsecespinfo
#define	INET_MODDESC	"IPsec ESP STREAMS module 1.15"
#define	INET_DEVDESC	"IPsec ESP STREAMS driver 1.15"
