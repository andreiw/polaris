...
#pragma ident	"@(#)icmpddi.c	1.45	05/06/08 SMI"
...
#define	INET_MODDESC	"ICMP STREAMS module 1.45"
#define	INET_DEVDESC	"ICMP STREAMS driver 1.45"
...
#define	INET_MODMTFLAGS (D_MP|D_MTPERQ|D_MTOUTPERIM|D_MTOCEXCL)
