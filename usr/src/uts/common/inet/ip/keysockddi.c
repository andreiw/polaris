...
#pragma ident	"@(#)keysockddi.c	1.9	05/06/08 SMI"
...
#define	INET_STRTAB	keysockinfo
#define	INET_MODDESC	"PF_KEY socket STREAMS module 1.9"
#define	INET_DEVDESC	"PF_KEY socket STREAMS driver 1.9"
