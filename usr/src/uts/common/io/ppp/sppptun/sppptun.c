...
#pragma ident	"@(#)sppptun.c	1.10	05/06/07 SMI"
...
const char sppptun_driver_description[] = "PPP 4.0 tunnel driver v1.10";
const char sppptun_module_description[] = "PPP 4.0 tunnel module v1.10";
#else
