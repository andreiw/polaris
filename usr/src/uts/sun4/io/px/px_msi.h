...
#pragma ident	"@(#)px_msi.h	1.4	05/10/13 SMI"
...
extern	int	px_msi_alloc(px_t *px_p, dev_info_t *rdip, int inum,
		    int msi_count, int flag, msinum_t *msi_num_p,
		    int *actual_msi_count_p);
