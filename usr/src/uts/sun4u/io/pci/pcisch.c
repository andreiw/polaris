...
#pragma ident	"@(#)pcisch.c	1.89	06/07/12 SMI"
...
pci_ib_setup(ib_t *ib_p)
{
	...
	ib_p->ib_slot_clear_intr_regs =
		a + SCHIZO_IB_CLEAR_INTR_REG_OFFSET;
	return (a);
}
...
cb_buserr_intr(caddr_t a)
{
	...
	if (CB_CHIP_TYPE(cb_p) == PCI_CHIP_TOMATILLO)
		...
		ret = safari_err_handler(pci_p->pci_dip, derr.fme_ena,
		    &cb_err);
...
static ecc_fm_err_t ecc_err_tbl[] = {
	PCI_ECC_PIO_UE, COMMON_ECC_UE_AFSR_E_PIO, CBNINTR_UE,
	...
	PCI_ECC_SEC_PIO_UE, COMMON_ECC_UE_AFSR_E_PIO,  CBNINTR_UE,
	PBM_SECONDARY, NULL, NULL, ACC_HANDLE,

	PCI_ECC_PIO_CE, COMMON_ECC_UE_AFSR_E_PIO,  CBNINTR_CE,
	PBM_PRIMARY, NULL, NULL, ACC_HANDLE,

	PCI_ECC_SEC_PIO_CE, COMMON_ECC_UE_AFSR_E_PIO,  CBNINTR_CE,
	PBM_SECONDARY, NULL, NULL, ACC_HANDLE,

	PCI_ECC_DRD_UE, COMMON_ECC_UE_AFSR_E_DRD, CBNINTR_UE,
	PBM_PRIMARY, NULL, NULL, DMA_HANDLE,

	PCI_ECC_SEC_DRD_UE, COMMON_ECC_UE_AFSR_E_DRD, CBNINTR_UE,
	PBM_SECONDARY, NULL, NULL, DMA_HANDLE,

	PCI_ECC_DRD_CE, COMMON_ECC_UE_AFSR_E_DRD, CBNINTR_CE,
	PBM_PRIMARY, NULL, NULL, DMA_HANDLE,

	PCI_ECC_SEC_DRD_CE, COMMON_ECC_UE_AFSR_E_DRD, CBNINTR_CE,
	PBM_SECONDARY, NULL, NULL, DMA_HANDLE,

	PCI_ECC_DWR_UE, COMMON_ECC_UE_AFSR_E_DWR, CBNINTR_UE,
	PBM_PRIMARY, NULL, NULL, DMA_HANDLE,

	PCI_ECC_SEC_DWR_UE, COMMON_ECC_UE_AFSR_E_DWR, CBNINTR_UE,
	PBM_SECONDARY, NULL, NULL, DMA_HANDLE,

	PCI_ECC_DWR_CE, COMMON_ECC_UE_AFSR_E_DWR, CBNINTR_CE,
	PBM_PRIMARY, NULL, NULL, DMA_HANDLE,

	PCI_ECC_SEC_DWR_CE, COMMON_ECC_UE_AFSR_E_DWR, CBNINTR_CE,
	PBM_SECONDARY, NULL, NULL, DMA_HANDLE,
