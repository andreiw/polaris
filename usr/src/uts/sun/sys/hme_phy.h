...
#ifndef	_SYS_HME_PHY_H
#define	_SYS_HME_PHY_H

#pragma ident	"@(#)hme_phy.h	1.12	05/06/08 SMI"
 ...
 */
#define	HME_PHY_BMCR	00	/* Basic Mode Control Register */
#define	HME_PHY_BMSR	01	/* Basic Mode Status Register */
#define	HME_PHY_IDR1	02	/* PHY Identifier Register 1 */
#define	HME_PHY_IDR2	03	/* PHY Identifier Register 2 */
#define	HME_PHY_ANAR	04	/* Auto-Negotiation Advertisement Register */
#define	HME_PHY_ANLPAR	05	/* Auto-Negotiation Link Partner Ability Reg */
#define	HME_PHY_ANER	06	/* Auto-Negotiation Expansion Register */
...
#define	HME_PHY_DIS	18	/* Disconnect Counter */
#define	HME_PHY_FCSC	19	/* False Carrier Sense Counter */
#define	HME_PHY_NWAYTR	20	/* NWay Test Register */
#define	HME_PHY_REC	21	/* RX_ER Counter */
#define	HME_PHY_SRR	22	/* Silicon Revision Register */
#define	HME_PHY_CSC	23	/* CS Configuration Register */
#define	HME_PHY_LBREMR	24	/* Loopback, Bypass, Receiver Error Mask Reg */
#define	HME_PHY_AR	25	/* PHY Address Register */
#define	HME_PHY_VRES1	26	/* Reserverd for future assignement by vendor */
#define	HME_PHY_TPISR	27	/* 10 Mbps TPI Status Register */
#define	HME_PHY_NICR	28	/* 10 Mbps Network I/F Configuration Register */
 ...
 */
#define	HME_PHY_BTXPC	31	/* BASE-TX Phy control Register */
 ...
 * Addition Interface Technologies Group (NPG) 8/28/1997.
 */
#define	PHY_BTXPC_DSCRAM	0x01	/* Disable data scrambling */
