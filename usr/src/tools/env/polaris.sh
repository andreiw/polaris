...
# Current PPC cross compiler has problems with some defines,
# so we are externally overriding them 
EXTRA_OPTIONS="-D__powerpc -U_BIG_ENDIAN";	export EXTRA_OPTIONS
