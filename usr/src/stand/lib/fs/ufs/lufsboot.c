...
#pragma ident	"@(#)lufsboot.c	1.6	05/06/08 SMI"
...
#elif defined(__powerpc) /* Add powerpc definition */
        /* KERNELBASE is defined in chrp/sys/machparam.h */
#define LOGBUF_BASEADDR ((caddr_t)(KERNELBASE - LOGBUF_MAXSIZE)) 
#endif
