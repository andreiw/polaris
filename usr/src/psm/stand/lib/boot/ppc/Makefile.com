...
#
# psm/stand/lib/boot/ppc/Makefile.com
#
# PowerPC architecture Makefile for Standalone Library
...
CPPINCS +=	-I$(SRC)/uts/ppc
CPPINCS +=	-I$(SRC)/uts/$(PLATFORM)
CPPINCS += 	# -I$(ROOT)/usr/platform/$(PLATFORM)/include #disabled it to pick userland headers which may cause conflicts
CPPINCS += 	-I$(PSMSYSHDRDIR)
CPPFLAGS =	$(CPPINCS) $(CCYFLAG)$(PSMSYSHDRDIR)
CPPFLAGS +=	-D_KERNEL -D_BOOT $(EXTRA_OPTIONS)
