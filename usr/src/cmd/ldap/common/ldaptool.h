...
#pragma ident	"@(#)ldaptool.h	1.1	03/10/03 SMI"
...
#define LDAPTOOL_DEFSSLSTRENGTH LDAPSSL_AUTH_CNCHECK
#else
...
#ifdef SOLARIS_LDAP_CMD
extern int		ldaptool_require_binddn;
#endif	/* SOLARIS_LDAP_CMD */
...
#ifdef SOLARIS_LDAP_CMD
char *ldaptool_UTF82local( const char * );
#endif	/* SOLARIS_LDAP_CMD */
