...
#
#pragma ident	"@(#)umountall.sh	1.32	06/01/26 SMI"
#
...
# Check and if needed sync the boot archive before unmounting things.
#
if [ -z "${RFLAG}${NFLAG}${HFLAG}" -a "$ZONENAME" = "global" -a \
